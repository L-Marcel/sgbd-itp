...
void seed_users() {
  ...
  Column columns[6] = {{.is_primary_key = true, .name = "Id", .type = T_NAT},
      {
  ...
  Record records[9][6] = {{{.value = "1"}, {.value = "Joao"}, {.value = "20"}, {.value = "1.80"},
                              {.value = "80.00"}, {.value = "M"}},
      {{.value = "2"}, {.value = "Maria"}, {.value = "25"}, {.value = "1.60"}, {.value = "60.00"},
          {.value = "F"}},
      {{.value = "3"}, {.value = "Jose"}, {.value = "30"}, {.value = "1.70"}, {.value = "70.00"},
          {.value = "M"}},
      {{.value = "4"}, {.value = "Ana"}, {.value = "35"}, {.value = "1.65"}, {.value = "65.00"},
          {.value = "F"}},
      {{.value = "5"}, {.value = "Pedro"}, {.value = "40"}, {.value = "1.75"}, {.value = "75.00"},
          {.value = "M"}},
      {{.value = "6"}, {.value = "Carla"}, {.value = "45"}, {.value = "1.55"}, {.value = "55.00"},
          {.value = "F"}},
      {{.value = "7"}, {.value = "Paulo"}, {.value = "50"}, {.value = "1.85"}, {.value = "85.00"},
          {.value = "M"}},
      {{.value = "8"}, {.value = "Julia"}, {.value = "55"}, {.value = "1.75"}, {.value = "75.00"},
          {.value = "F"}},
      {{.value = "9"}, {.value = "Marcos"}, {.value = "60"}, {.value = "1.65"}, {.value = "65.00"},
          {.value = "M"}}};
